...
SELECT * FROM album WHERE album_name LIKE "L%" OR  album_name LIKE "S%" OR album.album_name LIKE "P%";
...
SELECT * FROM album WHERE album_id != 4 AND album_id != 6 AND album_id > 2;
SELECT * FROM album WHERE album_name NOT LIKE "L%";
SELECT * FROM album WHERE album_name LIKE "S%" AND album_name NOT LIKE "%)";
SELECT * FROM artist WHERE (artist_name Like "%es" AND artist_name NOT LIKE "The%") OR (artist_name Like "The%" AND artist_name NOT LIKE "%es");
SELECT album_id FROM album WHERE album_name LIKE "%Brotherhood%";
SELECT * FROM track WHERE album_id = 7;
SELECT track_name, time FROM track WHERE time < 5.00;
SELECT track_name, artist_id FROM track ORDER BY time LIMIT 5;