...
INSERT INTO track (track_id, track_name, artist_id, album_id, time) VALUES (0,'Do You Love Me?',2,1,'5.95');
...
INSERT INTO track VALUES (2, 'Afro', 7, 1, '7.33');
INSERT INTO track VALUES (3, 'Melt', 7, 1, '5.21');
INSERT INTO track VALUES (4, 'Song of Life', 7, 1, '6.55');
INSERT INTO track VALUES (5, 'Original', 7, 1, '6.00');
INSERT INTO track VALUES (6, 'Black Flute', 7, 1, '3.46');
INSERT INTO track VALUES (7, 'Space Shanty', 7, 1, '7.15');
INSERT INTO track VALUES (8, 'Inspection Check One', 7, 1, '6.30');
INSERT INTO track VALUES (9, 'Storm 3000', 7, 1, '5.44');
INSERT INTO track VALUES (10, 'Bonus Track', 7, 1, '1.22');

SELECT SUM(time) From track Inner JOIN album Using (album_id, artist_id) WHERE album_id = 1 AND artist_id = 7;

SELECT artist_id FROM artist WHERE artist_name Like "%Rolling Stone%";
SELECT album_id FROM album WHERE artist_id = 4;
SELECT SUM(time) From track Inner JOIN album Using (album_id, artist_id) WHERE album_id = 1 AND artist_id = 4;

SELECT album_id FROM album WHERE album_name = "Leftism";
UPDATE track SET time = '6.22' WHERE track_name = 'Original' AND album_id = 1;

SELECT album_id FROM album WHERE album_name = "Leftism";
DELETE FROM track WHERE track_name = "Bonus Track" AND album_id = 1;

SELECT track_name FROM track ORDER BY time DESC LIMIT 1;